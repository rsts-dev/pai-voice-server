...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo
echo -e "${YELLOW}⚠️  DEPRECATED: This installation script is deprecated${NC}"
echo -e "${YELLOW}   Please use the NPM package instead:${NC}"
echo -e "${YELLOW}   npm install -g pai-voice-server${NC}"
echo -e "${YELLOW}   pai-voice-server install${NC}"
echo
read -p "Continue with legacy installation anyway? (y/n): " -n 1 -r
echo
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
